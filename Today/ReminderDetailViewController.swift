...
class ReminderDetailViewController: UITableViewController {
    ...
    fileprivate func transitionToEditMode(_ reminder: Reminder) {
        ...
        navigationItem.title = isNew ? NSLocalizedString("New Reminder", comment: "add new reminder nav title") : NSLocalizedString("Edit Reminder", comment: "edit reminder nav title")
...
extension ReminderDetailViewController {
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        if isEditing {
            ...
            guard let editSection = ReminderDetailEditDataSource.ReminderSection(rawValue: indexPath.section) else { return }
